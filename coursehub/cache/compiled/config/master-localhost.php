...
return [
    ...
    'checksum' => '6415d6e0163dafc6176541f7b5d9eb3c',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'plugins/markdown-fontawesome' => [
                'file' => 'user/config/plugins/markdown-fontawesome.yaml',
                'modified' => 1512492088
            ],
            ...
            'themes/my-course-hub-bones-theme' => [
                'file' => 'user/config/themes/my-course-hub-bones-theme.yaml',
                'modified' => 1512492089
            ]
        ],
        'system/config' => [
                ...
                'streams' => [
                    'schemes' => [
                        'theme' => [
                            ...
                            'prefixes' => [
                                '' => [
                                    0 => 'user/themes/my-course-hub-bones-theme',
                                    1 => 'user/themes/course-hub-bones'
                                ]
                            ]
                        ]
                    ]
