...
class __TwigTemplate_d2d81de4b4b09649bbbd5567009b46cda85602317290bebc4094b6db8f32e8fa extends Twig_Template
{
...
";
    ...
    public function block_page($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "admin", array()), "show_github_msg", array())) {
            // line 61
            echo "                            <div class=\"notice alert\"><i class=\"fa fa-mail\"></i> <a href=\"mailto:yangkecoy@gmail.com\" target=\"_blank\">";
    ...
    public function block_footer($context, array $blocks = array())
    {
        ...
        echo "                        <footer id=\"footer\">
                             <a href=\"http://seniorknows.com/coursehub\">Course Hub </a>";
        // line 67
        ...
        echo " <a href=\"http://seniorknows.com\">SeniorKnows.com</a>.
                        </footer>
                        ";
    }
                ...
                <div class=\"content-wrapper\">
                    <div class=\"{% if config.plugins.admin.content_padding %}content-padding{% endif %}\">
                        ...
                        <div class=\"default-box-shadow\">
                            ...
                            <div class=\"notice alert\"><i class=\"fa fa-mail\"></i> <a href=\"mailto:yangkecoy@gmail.com\" target=\"_blank\">{{ 'PLUGIN_ADMIN.ADMIN_REPORT_ISSUE'|tu }}</a></div>
                            {% endif %}
                            {% block content_bottom %}{% endblock %}
                        </div>
                        {% block footer %}
                        <footer id=\"footer\">
                             <a href=\"http://seniorknows.com/coursehub\">Course Hub </a>{{ \"PLUGIN_ADMIN.WAS_MADE_WITH\"|tu|lower }} <i class=\"fa fa-heart\"></i> {{ \"PLUGIN_ADMIN.BY\"|tu|lower }} <a href=\"http://seniorknows.com\">SeniorKnows.com</a>.
                        </footer>
                        {% endblock %}
                    </div>
                </div>
...
{% endif %}
", "partials/base-root.html.twig", "C:\\xampp\\htdocs\\seniorknows\\new_seniorknows_site_by_KeYang\\coursehub\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\base-root.html.twig");
    }
}
