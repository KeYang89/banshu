...
<p>
    To display one or many listings on a page copy and paste the PLUGIN CODE for each list on your SBWebApplication page. The plugin code for each list can be found on the <a :href="'../listings'" title=""Listings Page">Listings</a> page.
