<?php
/**
 * @var $view\SBWebApplication\View\View
 * @var $config array
 * @var $profileUser\SB\Userprofile\User\ProfileUser
 * @var \SBWebApplication\Site\Model\Node $node
 */

$view->script('userprofiles-details', 'sb/userprofile:app/bundle/userprofiles-details.js', ['vue']);
