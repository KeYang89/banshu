...
<div id="update" v-cloak>
    ...
    <p class="uk-alert uk-alert-warning" v-for="error in errors">No update or system down</p>
    ...
    <div v-show="update && view == 'index'">
        ...
        <div v-show="hasUpdate">
            ...
            <template v-if="!update.msg">
                ...
                <p>{{ 'Update to seniorknows.com %version% automatically or download the package and install it manually!' | trans update }}</p> 
                <p>{{ 'Read the changelog below to see what\'s new.'| trans update   }}</p>
            </template>
        ...
        <div v-show="!hasUpdate">
            <h2>{{ 'You have the latest version of seniorknows.com.' | trans }}</h2>
            <p>{{ 'You have the latest version of seniorknows.com. You do not need to update. However, if you want to re-install version %version%, you can download the package and re-install manually.' | trans update }}</p>
        </div>
