...
App::db()->insert('@system_widget', ['title' => 'Hello, I\'m SJZD', 'type' => 'system/text', 'status' => 1, 'nodes' => 1, 'data' => '{"content":"<h1 class=\"uk-heading-large uk-margin-large-bottom\">欢迎安装师姐知道<br class=\"uk-hidden-small\"> 请进入admin页面开始录入<\/h1>\n\n<a class=\"uk-button uk-button-large\" href=\"/chat">加入会议<\/a>"}']);

App::db()->insert('@system_widget', ['title' => 'Powered by Senior Knows Developer Group', 'type' => 'system/text', 'status' => 1, 'data' => '{"content":"<ul class=\"uk-grid uk-grid-medium uk-flex uk-flex-center\">\n    <li><a href=\"#" class=\"uk-icon-hover uk-icon-small uk-icon-github\"><\/a><\/li>\n    <li><a href=\"#" class=\"uk-icon-hover uk-icon-small uk-icon-twitter\"><\/a><\/li>\n   <li><a href=\"#" class=\"uk-icon-hover uk-icon-small uk-icon-google-plus\"><\/a><\/li>\n<\/ul>\n\n<p>Powered by <a href=\"https:\/\/seniorknows.com\">SJZD<\/a><\/p>"}']);
